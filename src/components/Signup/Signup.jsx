          ...
          <form action="" className="space-y-6">
            ...
            <div className = {`${styles.normalFlex} justify-between`} >
              <div className= {`${styles.normalFlex}`}>
                ...
                className="ml-2 block text-sm text-gray-500">Remember me
                </label>
              </div>
            ...
            <div>
              ...
              <div className="mt-2 flex items-center">
                ...
                <label htmlFor="file-input"className='ml-5 flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 '>
